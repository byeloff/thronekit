    ...
    const modalConfig = useMemo<{
        ...
        if (showVerificationStep) {
            return {
                ...
                buttonText: t('two_factor.setup.verify_continue'),
            };
        }

        return {
            title: t('two_factor.setup.enable_title'),
            description: t('two_factor.setup.enable_description'),
            buttonText: t('two_factor.setup.verify_continue'),
        };
